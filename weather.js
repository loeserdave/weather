$(function() {
  var handleWeatherResponse = function(data) {
    ...
    var markup = '<div class="row"><div class="col-xs-4"><h3>Current Weather Near You:</h3><table class="table-bordered table-hover"><tbody><tr><td class="table-body-bold">Temperature</td><td>' + currentTemp + '<img id="fahrenheit" src="SVG/Degrees-Fahrenheit.svg"></tr><tr><td class="table-body-bold">Current Summary</td><td>' + currentSummary + currentImage + '</td></tr><tr><td class="table-body-bold">Daily Summary</td><td>' + dailySummary + '</tbody></div></div>'
    // End of your code
